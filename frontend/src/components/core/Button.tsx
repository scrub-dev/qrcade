...
export const defaultButtonStyleAlt = "text-2xl px-4 py-1 bg-main rounded font-graffiti text-white bg-secondary_dark hover:bg-secondary hover:shadow-lg hover:shadow-main"
